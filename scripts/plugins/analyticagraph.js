...
*
*
*Construire un grahique avec legende et slider à partir d'un tableau d'objets Json sous
...
*	};
*
*Revoir les paramètres d'entrée, pour indiquer le type de associé à chaque jeu de donnée, le type sera
*un tableau de String de même taille que le tableau dataSeries 
*
